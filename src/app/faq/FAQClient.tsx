...
const FAQS = [
  ...
  },
  {
    ...
    answer:
      "No, our platform only aggregates reviews from other publicly available sources and does not collect reviews on its own.",
  },
  {
    ...
    <main>
      ...
      <section className="section-container section-spacing-md">
        <div className="space-y-6">
          {FAQS.map((faq, idx) => (
            <div key={faq.question} className="bg-[#233665]/5 rounded-2xl shadow-md">
              <button
